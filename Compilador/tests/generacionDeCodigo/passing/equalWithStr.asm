...
beq $a0, $zero, elseif_startnull104
#SENTENCIA DEL IF
...
#CONTINUA IF THEN ELSE
#Verifica si la condicion es falsa. Si es falsa salta a la etiqueta else 
beq $a0, $zero, elseif_startnull134
#SENTENCIA DEL IF
#Sentencias del bloque de un metodo 
#SIMPLE SENTENCE - CODE GEN DE EXPRESION
#METHOD CALL 
...
#CONTINUA IF THEN ELSE
#Verifica si la condicion es falsa. Si es falsa salta a la etiqueta else 
beq $a0, $zero, elseif_startnull164
#SENTENCIA DEL IF
#Sentencias del bloque de un metodo 
#SIMPLE SENTENCE - CODE GEN DE EXPRESION
#METHOD CALL 
...
#CONTINUA IF THEN ELSE
#Verifica si la condicion es falsa. Si es falsa salta a la etiqueta else 
beq $a0, $zero, elseif_startnull194
#SENTENCIA DEL IF
#Sentencias del bloque de un metodo 
#SIMPLE SENTENCE - CODE GEN DE EXPRESION
#METHOD CALL 
...
#CONTINUA IF THEN ELSE
#Verifica si la condicion es falsa. Si es falsa salta a la etiqueta else 
beq $a0, $zero, elseif_startnull224
#SENTENCIA DEL IF
#Sentencias del bloque de un metodo 
#SIMPLE SENTENCE - CODE GEN DE EXPRESION
#METHOD CALL 
...
#CONTINUA IF THEN ELSE
#Verifica si la condicion es falsa. Si es falsa salta a la etiqueta else 
beq $a0, $zero, elseif_startnull254
#SENTENCIA DEL IF
#Sentencias del bloque de un metodo 
#SIMPLE SENTENCE - CODE GEN DE EXPRESION
#METHOD CALL 
...
#CONTINUA IF THEN ELSE
#Verifica si la condicion es falsa. Si es falsa salta a la etiqueta else 
beq $a0, $zero, elseif_startnull284
#SENTENCIA DEL IF
#Sentencias del bloque de un metodo 
#SIMPLE SENTENCE - CODE GEN DE EXPRESION
#METHOD CALL 
